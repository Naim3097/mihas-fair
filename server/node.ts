...
const app = createApp({ ...buildServices({ db, secret, level, publicOrigin: PUBLIC_ORIGIN, playgroundDaily: process.env.PLAYGROUND_DAILY === '1', live: prod }), crewPin, publicOrigin: PUBLIC_ORIGIN, secureCookies: prod });
