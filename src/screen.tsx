  ...
  return (
    <div class="mc">
      ...
      <aside class="mc-right">
        <div class="mc-join"><Qr text={v?.joinUrl ?? location.origin} label="Join Mission X" /><strong>Play the expo.</strong><span>Scan · no app · find the <b>X</b> at 7E17</span></div>
        <div class="mc-stats">
      ...
      <footer>
        ...
        <span class="tick">✕ Find the X · Booth 7E17 · Hall 7 · your free digital business card</span>
      </footer>
    </div>
  );
}
